...
public class FinalScorecard {
	...
	private MatchOverScreen Screen;
	private String Mode;	
	private Texture CCS1, CCS2, LSS1, LSS2;
	private BitmapFont Font;
	
	public FinalScorecard (String inMode, MatchOverScreen inScreen)
	{
		Mode = inMode;
		Screen = inScreen;
	...
	public void Render(SpriteBatch Batch)
	{
		...
		if (Mode == "CCF")
		{
			...
			for (int i=1; i <= 9; i++)
			{
				Total += Screen.Scores[i];
			}
			
			Font.draw(Batch, Total+"", 429, 545);
		}
		else if (Mode == "CCB")
		{
